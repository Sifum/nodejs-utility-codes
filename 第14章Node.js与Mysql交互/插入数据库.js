...
http.createServer(function(req, res){
    ...
    if(db){
        ...
        console.info();
        db.query('insert into users (user_name, user_age) values ("Wanna", 24);', function(err, rows){
            if(err) throw err;
            else {
...
{"fieldCount":0,"affectedRows":1,"insertId":3,"serverStatus":2,"warningCount":0,"message":"","protocol41":true,"changedRows":0}
